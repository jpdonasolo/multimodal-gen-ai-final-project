...
Then, make sure to have [uv](https://docs.astral.sh/uv/getting-started/installation/) installed, go to the root directory of the project and run `uv run python SSV2A/infer_i2a.py --cfg models/ssv2a.json --ckpt models/ssv2a.pth --image_dir ./img --out_dir ./output`.
